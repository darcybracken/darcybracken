...
# D'Arcy Bracken
GRC and vulnerability management practitioner building a portfolio across compliance, detection, and offensive security. Background in B2B tech sales means I already understand how organizations communicate risk upward and why controls exist to protect business outcomes, not just pass audits.
...
![Network+](https://img.shields.io/badge/CompTIA%20Network%2B-In%20Progress-E31837?style=flat&logo=comptia&logoColor=white)
...
**[Network Vulnerability Assessment](https://github.com/darcybracken/network-vulnerability-assessment)**
Full-lifecycle vulnerability assessment against Metasploitable 2 on an isolated UTM lab. Covers network discovery and stealth scanning with Nmap, automated vulnerability scanning with Nessus Essentials mapped to CVSS v3.1, and plaintext credential capture with Wireshark. Includes setup guide and Nmap deep-dive reference.
